//===- GameBoyShift.cpp - Shift Expansion Pass --------------------------------===//
//
...
/// like GameBoy-gcc. This must be done in IR because otherwise the type legalizer
...
class GameBoyShiftExpand : public FunctionPass {
public:
  static char ID;

  GameBoyShiftExpand() : FunctionPass(ID) {}

  bool runOnFunction(Function &F) override;

  StringRef getPassName() const override { return "GameBoy Shift Expansion"; }
...
char GameBoyShiftExpand::ID = 0;

INITIALIZE_PASS(GameBoyShiftExpand, "GameBoy-shift-expand", "GameBoy Shift Expansion",
                false, false)

Pass *llvm::createGameBoyShiftExpandPass() { return new GameBoyShiftExpand(); }

bool GameBoyShiftExpand::runOnFunction(Function &F) {
...
void GameBoyShiftExpand::expand(BinaryOperator *BI) {
