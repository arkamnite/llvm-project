//===-- GameBoySubtarget.h - Define Subtarget for the GameBoy -----------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the GameBoy specific subclass of TargetSubtargetInfo.
//
//===----------------------------------------------------------------------===//
...
/// A specific GameBoy target MCU.
class GameBoySubtarget : public GameBoyGenSubtargetInfo {
public:
  //! Creates an GameBoy subtarget.
