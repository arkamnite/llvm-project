//===-- GameBoyFixupKinds.h - GameBoy Specific Fixup Entries ------------*- C++ -*-===//
//
...
#ifndef LLVM_GameBoy_FIXUP_KINDS_H
#define LLVM_GameBoy_FIXUP_KINDS_H
...
///       MCFixupKindInfo Infos[GameBoy::NumTargetFixupKinds]
///       in `GameBoyAsmBackend.cpp`.
enum Fixups {
  /// A 32-bit GameBoy fixup.
  ...
  ///       The nonmenclature is that GameBoy branch targets are
...
/// All branch targets in GameBoy are rightshifted by 1 to take advantage
...
#endif // LLVM_GameBoy_FIXUP_KINDS_H
