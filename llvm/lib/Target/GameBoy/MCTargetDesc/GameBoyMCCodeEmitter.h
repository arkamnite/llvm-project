//===-- GameBoyMCCodeEmitter.h - Convert GameBoy Code to Machine Code -------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the GameBoyMCCodeEmitter class.
//
//===----------------------------------------------------------------------===//
//

#ifndef LLVM_GameBoy_CODE_EMITTER_H
#define LLVM_GameBoy_CODE_EMITTER_H

#include "GameBoyFixupKinds.h"
...
/// Writes GameBoy machine code to a stream.
class GameBoyMCCodeEmitter : public MCCodeEmitter {
public:
  GameBoyMCCodeEmitter(const MCInstrInfo &MCII, MCContext &Ctx)
      : MCII(MCII), Ctx(Ctx) {}
...
private:
  ...
  GameBoyMCCodeEmitter(const GameBoyMCCodeEmitter &) = delete;
  void operator=(const GameBoyMCCodeEmitter &) = delete;
...
#endif // LLVM_GameBoy_CODE_EMITTER_H
